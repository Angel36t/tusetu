...
import videoFile from "../../../../../../components/video/vibration/instruccion.mp4";
...
const VideoJSPlayer = () => {
  ...
  const [loadingThumbnail, setLoadingThumbnail] = useState(true); // loader para el thumbnail
  ...
  useEffect(() => {
    ...
    const captureThumbnail = () => {
      ...
      setLoadingThumbnail(false); // ocultar loader
    };

    const handleLoadedMetadata = () => {
      const randomTime = Math.floor(Math.random() * 61); // 0 a 60 segundos
  ...
  return (
    <div className="mx-auto">
      <div className="relative w-full h-[500px]"> {/* Fijamos alto aquí */}
        {/* Loader mientras carga el thumbnail */}
        {loadingThumbnail && (
        ...
        {/* Mostrar thumbnail una vez cargado */}
        {!showVideo && thumbnail && !loadingThumbnail && (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                <img src="/icon/play-button.svg" alt="Play Icon" className="w-16 h-16" />
              </button>
            </div>
          </div>
        )}
        ...
        {/* Hidden video para generar el thumbnail */}
        <video
          ref={hiddenVideoRef}
          src={videoFile}
          style={{ display: "none" }}
