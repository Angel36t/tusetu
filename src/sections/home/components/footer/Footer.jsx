const navigation = {
  main: [
    ...
    { name: "¿Quién soy?", href: "#quiensoy" },
    { name: "¿Cuál es mi propósito?", href: "#proposito" },
    // { name: "Blog", href: "#" },
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/E3alexander/",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/alexander_assad/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@alexanderassad/videos",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
